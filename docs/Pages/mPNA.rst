...
.. ipython::
    ...
    In [3]: Athaliana_mito="data/A_thaliana_mitochondria.fasta"
...
k-mers from our greengenes data-set to the *A. thaliana* mitochondria
...
.. ipython::
    ...
    In [7]: designer_mPNA = MAPT.PNA_Designer(result_file = 'data/mPNA.csv', target_fastafile = Athaliana_mito, sequence_file = greengenes_fasta, primer_F=F515,primer_R = R926, kmer_range = krng)
...
.. ipython::
    ...
    In [9]: mPNA = "GGCAAGTGTTCTTCGGA"

    In [9]: mapping = designer_mPNA.map_PNA(mPNA,antiparallel_only=False)
